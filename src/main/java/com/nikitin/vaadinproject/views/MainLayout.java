...
import com.nikitin.vaadinproject.data.entity.User;
import com.nikitin.vaadinproject.security.AuthenticatedUser;
import com.nikitin.vaadinproject.views.about.AboutView;
import com.nikitin.vaadinproject.views.helloworld.HelloWorldView;
...
public class MainLayout extends AppLayout {
    ...
    private MenuItemInfo[] createMenuItems() {
        return new MenuItemInfo[]{ //
                new MenuItemInfo("Hello World", "la la-user", HelloWorldView.class), //
